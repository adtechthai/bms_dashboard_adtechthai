...
export default function BMSDashboardToday() {
  ...
  const fetchMetrics = async () => {
    try {
      ...
      // Use Bangkok timezone for today's data
      const now = new Date()
      ...
      try {
        ...
        if (chatData) {
          totalChat = (chatData as any)?.today_count || 0
        }

        // Fetch Intent Statistics
        const { data: intentData } = await supabase
          .from('intent_statistics')
          .select('intent_type, today_count')

        if (intentData) {
          intentData.forEach((item: any) => {
            intentMap.set(item.intent_type, item.today_count || 0)
          })
        }
        ...
        if (purchaseData) {
          totalBuyValue = (purchaseData as any)?.today_count || 0
        }
        ...
        totalChat = 150
        intentMap.set('Lead', 45)
        intentMap.set('Purchase', 12)
        intentMap.set('VC', 80)
        intentMap.set('ATC', 35)
        intentMap.set('IC', 20)
        intentMap.set('Move to Spam', 8)
        intentMap.set('Blocking', 3)
        intentMap.set('Ban', 2)
        totalBuyValue = 45000
      }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">กำลังโหลดข้อมูลวันนี้...</p>
        </div>
      </div>
    )
  }
            ...
            <div>
              <div className="flex items-center space-x-4 mb-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900">BMS Dashboard - วันนี้</h1>
                </div>
              </div>
              <p className="text-sm text-gray-600">
                ข้อมูล ณ วันที่ {lastUpdated} (เวลาไทย GMT+7)
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-blue-50 border-blue-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-blue-700">จำนวนแชททั้งหมดวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-green-50 border-green-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-green-700">จำนวนลีดวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-purple-50 border-purple-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-purple-700">จำนวนการซื้อวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-yellow-50 border-yellow-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-yellow-700">มูลค่าการซื้อวันนี้</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-indigo-50 border-indigo-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-indigo-700">อัตราแปลงแชทเป็นลีดวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-teal-50 border-teal-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-teal-700">อัตราแปลงลีดเป็นการซื้อวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-rose-50 border-rose-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-rose-700">อัตราแปลงแชทเป็นการซื้อวันนี้</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-emerald-50 border-emerald-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-emerald-700">ลูกค้าที่มีคุณภาพวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-sky-50 border-sky-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-sky-700">จำนวนการดูเนื้อหาวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-orange-50 border-orange-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-orange-700">จำนวนการเพิ่มสินค้าวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-violet-50 border-violet-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-violet-700">จำนวนการเริ่มชำระเงินวันนี้</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-red-50 border-red-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-red-700">ลูกค้าที่มีปัญหาวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-amber-50 border-amber-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-amber-700">จำนวนสแปมวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-50 border-slate-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-slate-700">จำนวนการบล็อกวันนี้</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-50 border-gray-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-700">จำนวนการแบนวันนี้</p>
            </CardContent>
          </Card>
        </div>
      </div>
